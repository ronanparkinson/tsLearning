...
//method overloading but can change the return type depending on the parameters
...
const storedData = userInputt ?? 'DEFAULT'; //this will output DEFAULT if userInputt is underfined
